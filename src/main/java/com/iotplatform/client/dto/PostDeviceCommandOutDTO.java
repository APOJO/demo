...
// Source File Name:   PostDeviceCommandOutDTO.java
...
/**
 * @deprecated Class PostDeviceCommandOutDTO is deprecated
 */

public class PostDeviceCommandOutDTO
{

    public PostDeviceCommandOutDTO()
    {
    }
