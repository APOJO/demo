...
// Source File Name:   RuleDTO2.java
...
//            TimeRange, GroupExpress2

public class RuleDTO2
{
    ...
    public GroupExpress2 getGroupExpress()
    {
        return groupExpress;
    }

    public void setGroupExpress(GroupExpress2 groupExpress)
    {
    ...
    private GroupExpress2 groupExpress;
    ...
    private List tags;
    private List rulePreProcessors;
}
